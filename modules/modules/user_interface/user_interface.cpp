...
static void userInterfaceMatrixKeypadUpdate()
{
    ...
    if( keyReleased != '\0' ) 
    {
        ...
        clearDisplayRange(0, 0, 0, 15);
        clearDisplayRange(1, 0, 1, 15);
          
        displayCharPositionWrite ( 0,0 );
        displayStringWrite( "Pls only enter" );

        displayCharPositionWrite ( 0,1 );
        displayStringWrite( "numbers" );
